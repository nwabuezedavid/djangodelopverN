    ...
    >
      <Link href="/Post">
        <main className=" rounded relative w-full h-[330px]  bg-black">
          ...
          <h2 className='text-[140%]'>Tyla</h2>
          <p className='flex w-fit text-[70%] truncate'> @miweeyr__james <Check className='w-3 h-3 p-0.5 text-white ml-1 rounded-full bg-cyan-300'/> </p>
          <button className="w-[80%] h-fit hover:bg-white hover:text-red-800 bg-red-600 py-2 rounded px-5">follow</button>
       </div>
        </main>
      </Link>
