    ...
    >
      <Link href="/Post">
        <main className=" rounded relative w-full h-[330px]  bg-black">
          ...
          <button className="w-[80%] h-fit hover:rounded-none  hover:bg-gray-200 bg-white text-red-800  py-2 rounded px-5 capitalize">view profile</button>
       </div> {console.log(data?.data?.follower?.videos[0].user?.username, "inner")}
        </main>
      </Link>
